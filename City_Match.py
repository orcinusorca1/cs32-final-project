...
# NEW**** Kids question is now part of preferences, not a separate section.
...
# adjustment is baked into the weighting system rather than added as
...
# "You might also like" — tied to what the user actually values most
